...
var oaoApplicant = new mongoose.Schema({
    ...
    //New Variables
    retirementYears:{type: String},
    retirementMonths:{type: String},
    years: { type: String },
    months: { type: String },
    ...
    thirdyears: { type: String },
    thirdmonths: { type: String },
    thirdaddress: { type: String },
    thirdhousenum: { type: String },
    thirdstreetnum: { type: String },
    thirdstreetname: { type: String },
    thirdstreettype: { type: String },
    thirdsuburb: { type: String },
    thirdstate: { type: String },
    thirdpostcode: { type: String },
    ...
    assets: [],
    Liabilities: [],
    showAssets: { type: Boolean },
    showLiabilities: { type: Boolean },
    ...
    bot_fields: [{
        ...
        socialId: { type: String, default: 'Na' },
        botContacted: { type: String, default: 'N' },
        noOfRemaindersSent: { type: Number, default: 0 }
    }],
